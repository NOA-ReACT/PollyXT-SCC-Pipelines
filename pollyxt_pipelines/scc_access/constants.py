...
list_measurements_url = urlparse.urljoin(
...
download_cloudmask_pattern = urlparse.urljoin(BASE_URL,
                                              'data_processing/measurements/{0}/download-cloudmask/')

download_preprocessed_pattern = urlparse.urljoin(BASE_URL,
                                                 'data_processing/measurements/{0}/download-preprocessed/')
download_optical_pattern = urlparse.urljoin(BASE_URL,
                                            'data_processing/measurements/{0}/download-optical/')
download_graph_pattern = urlparse.urljoin(BASE_URL,
                                          'data_processing/measurements/{0}/download-plots/')
download_elic_pattern = urlparse.urljoin(BASE_URL,
